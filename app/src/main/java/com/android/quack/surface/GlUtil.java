...
//        FloatBuffer fb = ByteBufferFactory.createFloatBuffer(coords.length * SIZEOF_FLOAT);
//        fb.put(coords);
//        fb.position(0);
//        return fb;
//    }
    ...
    public static String readTextFromRawResource(final Context applicationContext, @RawRes final int resourceId) {
        ...
        return readTextFromRawResource(inputStream);
    }

    public static String readTextFromRawResource(InputStream inputStream) {
